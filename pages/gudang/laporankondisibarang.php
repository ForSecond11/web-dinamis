...
if 	(isset($_GET['txtkatakunci'])){
	...
	$query = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * from data_barang where kondisi LIKE '%".$kata."%' GROUP BY kode_barang");
}
else{
$query = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * from data_barang GROUP BY kode_barang");
}
?>
