...
<input type="hidden" value="<?php echo $_POST['tglr2']; ?>" name="tgl2" />
	...
	$count_query=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT COUNT(id_".$_POST['lp'].") AS numrows
FROM barang_".$_POST['lp']." LEFT JOIN data_barang ON barang_".$_POST['lp'].".kode_barang = data_barang.kode_barang  Where tgl BETWEEN '".$_POST['tglr']."' AND '".$_POST['tglr2']."' GROUP BY id_".$_POST['lp']."");
	$count_query2   = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT COUNT(ID_".$_POST['lp'].") AS numrows FROM barang_".$_POST['lp']." Where tgl BETWEEN '".$_POST['tglr']."' AND '".$_POST['tglr2']."'");
	...
	$query2 = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * from barang_".$_POST['lp']." Where tgl BETWEEN '".$_POST['tglr']."' AND '".$_POST['tglr2']."' GROUP BY id_".$_POST['lp']." LIMIT $offset,$per_hal");
	$query=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT barang_".$_POST['lp'].".tgl, barang_".$_POST['lp'].".kode_barang, data_barang.nama_barang, barang_".$_POST['lp'].".jumlah
...
<div>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
    <td width="89%"><button onclick="window.print()">Cetak Halaman Web</button></td>
    <td width="11%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        
        <td width="17%">Export To <img src="img/excel.ico" border="1" width="32" height="32" onClick="window.open('<?php echo "pages/web/export-excel-barang.php?tgl1=".$_POST['tglr']."&tgl2=".$_POST['tglr2']."&field=".$_POST['lp']; ?>','popuppage','width=500,toolbar=0,resizable=0,scrollbars=no,height=400,top=100,left=100');" /></td>
